...
public class GlobalExcpetion extends ResponseEntityExceptionHandler{
	 ...
	 @ExceptionHandler(IdNotFoundException.class) public
	  ...
	  idNotFoundException(IdNotFoundException ex) {ErrorDetails
	  ...
	  return new
	  ResponseEntity<ErrorDetails>(response,HttpStatus.NOT_FOUND); }
	 
	
	 
	 @ExceptionHandler(RecordsNotFoundException.class) public
	  ResponseEntity<ErrorDetails>
	  idNotFoundException(RecordsNotFoundException ex) {ErrorDetails
	  response= new ErrorDetails(); 
